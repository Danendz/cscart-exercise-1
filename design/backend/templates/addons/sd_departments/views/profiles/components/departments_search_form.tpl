...
{if $smarty.request.redirect_url}
    <input 
        type="hidden" 
        name="redirect_url" 
        value="{$smarty.request.redirect_url}" 
    />
{/if}
...
{$extra nofilter}
	<div class="sidebar-field">
	    <label for="elm_name">{__("sd_departments_department_name")}</label>
	    <div class="break">
	        <input 
            type="text" 
    ...
    <div class="sidebar-field">
        <label for="elm_supervisor">{__("sd_departments_supervisor")}</label>
	    <div class="controls">
	        {include 
